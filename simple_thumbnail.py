...
def create_thumbnail():
    ...
    draw.text((250, 220), "Enterprise Energy Consumption MLOps Pipeline", fill=(148, 163, 184), font=font_medium)
    draw.text((250, 270), "Azure-Native • Production-Ready • Staff-Level Engineering", fill=(100, 116, 139), font=font_small)
    ...
    for i, fill_ratio in enumerate([0.85, 0.92, 0.78, 0.95]):
        ...
        draw.rectangle([bar_x, y_pos, bar_x + int(250 * fill_ratio), y_pos + 20], fill=(59, 130, 246))
    ...
    draw.text((870, 562), "github.com/sankeashok/Helios-Grid", fill=(255, 255, 255), font=font_small)
