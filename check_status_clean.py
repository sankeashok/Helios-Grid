            ...
            try:
                ...
                if jobs_response.status_code == 200:
                    ...
                    for job in jobs:
                        ...
                        print(
                            f"     {job_status_text} {job_name}: {job_status}/{job_conclusion}"
                        )
...
def get_latest_failed_jobs():
    ...
    try:
        ...
        clean_title = (
            failed_run["display_title"].encode("ascii", "ignore").decode("ascii")
        )
        ...
        if jobs_response.status_code == 200:
            ...
            for job in failed_jobs:
                ...
                if failed_steps:
                    ...
                    for step in failed_steps:
                        print(
                            f"  - {step['name']} (started: {step.get('started_at', 'N/A')})"
                        )
                        if step.get("number"):
