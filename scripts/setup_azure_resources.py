...
class AzureResourceManager:
    ...
    def create_storage_account(self, storage_account_name: str) -> Dict[str, str]:
        ...
        try:
            ...
            if not availability.name_available:
                logger.error(f"Storage account name not available: {availability.reason}")
                return {}
            ...
            poller = self.keyvault_client.vaults.begin_create_or_update(
                ...
                keyvault_name,
                {
                    ...
                    'properties': {
                        ...
                        'tenant_id': self.credential._get_token('https://management.azure.com/.default').token,
                        'access_policies': [
                            {
                                'tenant_id': self.credential._get_token('https://management.azure.com/.default').token,
    ...
    def create_ml_workspace(self, workspace_name: str, 
                           storage_account: str, keyvault_name: str) -> Dict[str, str]:
...
def setup_azure_resources(subscription_id: str, resource_group: str, location: str,
                         storage_account: str, keyvault_name: str, workspace_name: str,
    ...
    # Create ML Workspace
    workspace_info = arm.create_ml_workspace(workspace_name, storage_account, keyvault_name)
