...
def check_repo_settings():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"   - Required status checks: {protection_data.get('required_status_checks', 'None')}")
    ...
    print("=" * 50)
    print("1. Repository Settings -> Actions -> General:")
